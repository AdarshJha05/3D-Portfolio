...
`,L=()=>{let e=(0,i.useRef)(),[t,n]=(0,i.useState)(!1);return(0,D.jsx)(O,{id:`Education`,children:(0,D.jsxs)(k,{children:[(0,D.jsx)(A,{children:`Contact`}),(0,D.jsx)(j,{style:{marginBottom:`40px`},children:`Feel free to reach out to me for any questions or opportunities!`}),(0,D.jsxs)(M,{ref:e,onSubmit:async t=>{t.preventDefault();let r=localStorage.getItem(`lastEmailSent`);if(r){let e=new Date(r).getTime(),t=(new Date().getTime()-e)/(1e3*60);if(t<5){let e=Math.ceil(5-t);alert(`For spam prevention, please wait ${e} minute(s) before sending another message.`);return}}n(!0);try{await E.sendForm(`service_q70ivne`,`template_4uark1h`,e.current,{publicKey:`0iupQKOvHiwm3mHaq`}),localStorage.setItem(`lastEmailSent`,new Date().toISOString()),alert(`Message Sent Successfully!`),e.current.reset()}catch(e){console.error(e),alert(`Failed to send message: `+(e.text||e.message||JSON.stringify(e)))}finally{n(!1)}},children:[(0,D.jsx)(N,{children:`Let's Connect`}),(0,D.jsx)(P,{type:`email`,placeholder:`Your Email Address`,name:`from_email`,required:!0}),(0,D.jsx)(P,{placeholder:`Your Full Name`,name:`from_name`,required:!0}),(0,D.jsx)(P,{placeholder:`Company / Organization (Optional)`,name:`company`}),(0,D.jsx)(P,{placeholder:`Subject`,name:`subject`,required:!0}),(0,D.jsx)(F,{placeholder:`How can I help you?`,name:`message`,rows:5,required:!0}),(0,D.jsx)(I,{type:`submit`,value:t?`Sending...`:`Send Message`,disabled:t})]})]})})};export{L as default};